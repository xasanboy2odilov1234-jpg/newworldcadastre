export const translations = {
  ru: {
    ...
    hero: {
      badge: "Гарантия результата",
      headline: "Кадастровые и геодезические работы любой сложности.",
      subtitlePrefix: "Точность, создающая ",
      subtitleHighlight: "уверенность.",
      btn1: "Наши услуги",
      btn2: "О компании",
      loc: "Ташкент, Узбекистан",
      time: "Пн - Пт · 9:00 – 18:00",
      exp: "Опыт работы более 10 лет",
    },
    calculator: {
      title: "Рассчитать стоимость",
      subtitle: "Три простых шага — и вы узнаете ориентировочную цену работ.",
      stepOf: "Шаг",
      of: "из",
      step1: "Выберите тип объекта",
      step2: "Укажите площадь",
      step3: "Контакт и детали",
      house: "Дом",
      land: "Земля",
      commercial: "Коммерция",
      areaLabelSotka: "Площадь (соток)",
      areaLabelM2: "Площадь (м²)",
      areaPlaceholder: "Например, 5",
      phoneLabel: "Номер телефона",
      detailsLabel: "Дополнительные детали",
      detailsPlaceholderHouse:
        "Например: квартира в центре города, техпаспорт для нового собственника, пристройка к дому...",
      detailsPlaceholderLand:
        "Например: раздел земельного участка, уточнение границ, пустой участок под строительство...",
      detailsPlaceholderCommercial:
        "Например: оформление магазина на нового собственника, размеры склада, кадастр для офисного здания...",
      next: "Далее",
      back: "Назад",
      submit: "Рассчитать",
      submitting: "Отправка...",
      trustNote: "Расчёт придёт в Telegram. Без назойливых звонков.",
      successTitle: "Спасибо! Ваш запрос принят.",
      successText: "Наш специалист свяжется с вами в течение 10 минут.",
      reset: "Новый расчёт",
      errorType: "Выберите тип объекта",
      errorArea: "Укажите корректную площадь",
  ...
  uz: {
    ...
    hero: {
      badge: "Natija kafolati",
      headline: "Har qanday murakkablikdagi kadastr va geodeziya ishlari.",
      subtitlePrefix: "Ishonch bag'ishlovchi ",
      subtitleHighlight: "aniqlik.",
      btn1: "Bizning xizmatlar",
      btn2: "Kompaniya haqida",
      loc: "Toshkent, O'zbekiston",
      time: "Dush - Jum · 9:00 – 18:00",
      exp: "10 yildan ortiq ish tajribasi",
    },
    calculator: {
      title: "Narxni hisoblash",
      subtitle: "Uch oddiy qadam — ishlarning taxminiy narxini biling.",
      stepOf: "Qadam",
      of: "/",
      step1: "Obyekt turini tanlang",
      step2: "Maydonni kiriting",
      step3: "Aloqa va tafsilotlar",
      house: "Uy",
      land: "Yer",
      commercial: "Tijorat",
      areaLabelSotka: "Maydon (sotix)",
      areaLabelM2: "Maydon (m²)",
      areaPlaceholder: "Masalan, 5",
      phoneLabel: "Telefon raqami",
      detailsLabel: "Qo'shimcha tafsilotlar",
      detailsPlaceholderHouse:
        "Masalan: shahar markazidagi kvartira, yangi egasiga texpasport rasmiylashtirish, uyga qo'shimcha bino...",
      detailsPlaceholderLand:
        "Masalan: yer uchastkasini bo'lish, chegaralarni aniqlash, qurilish uchun bo'sh yer...",
      detailsPlaceholderCommercial:
        "Masalan: do'konni yangi egasiga rasmiylashtirish, omborxona o'lchami, ofis binosi uchun kadastr...",
      next: "Keyingi",
      back: "Orqaga",
      submit: "Hisoblash",
      submitting: "Yuborilmoqda...",
      trustNote: "Hisob-kitob Telegramga keladi. Bezovta qiluvchi qo'ng'iroqlarsiz.",
      successTitle: "Rahmat! So'rovingiz qabul qilindi.",
      successText: "Mutaxassisimiz 10 daqiqa ichida siz bilan bog'lanadi.",
      reset: "Yangi hisob",
      errorType: "Obyekt turini tanlang",
      errorArea: "To'g'ri maydonni kiriting",
      errorPhone: "Telefon raqamini kiriting",
      errorSubmit: "Arizani yuborib bo'lmadi. Qayta urinib ko'ring.",
    },
    companyInfo: {
